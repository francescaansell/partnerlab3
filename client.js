...
function getReservationUsername(){
    ...
    try{
        request.open("GET", "http://localhost:3000/reservation/user/" + path, true);
...
function addUser(){
    ...
    try {
        request.open("POST", "http://localhost:3000/users/" + user, true);
...
function addReservation(){
    ...
    try {
    request.open("POST", `http://localhost:3000/reservation/user/${username}/startDate/${startDate}/startTime/${startTime}/numHours/${numHours}` , true);
...
function deleteReservation(){
    ...
    try {
        request.open("DELETE", "http://localhost:3000/reservation/user/" + username, true);
